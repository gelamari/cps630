...
if ($btn_name == 'Update') {
$a_id    = $data->a_id;
$query = "UPDATE attractions SET title = '$title', continent = '$continent', country = '$country' , founder_name = '$founder_name', date_of_creation = '$date_of_creation', dimensions = '$dimensions', location = '$location' WHERE a_id = '$a_id'";
